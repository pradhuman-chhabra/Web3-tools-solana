  ...
  return (
    <>
      <div className="textAlign container">
        <h1 className="containerH1">Vision</h1>
        <ul>
          <p>
            Our vision is to carry out research on new OP Medicine's models that
          ...
          <p>
            OP Medicine utilizes a distributed computer network platform that
            enables databases to store time-stamped transaction records and
            documents. Each server (or node) in the network processes and
            verifies each data entry, then archives all transactions, along with
            the history trail, which is every transaction ever recorded to the
            network.
          </p>
          <p>
          ...
          <br />
          <p>
            OP Medicine's will be able to directly increase the quantity and
            quality of patients enrolled for clinical trials in a number of
            ways. This type of distributed ledger could allow individual
            patients to store their medical data by anonymous methods, thereby
            making it visible to trial recruiters, who could then reach out to
            the patients if their data qualifies for the clinical trial.
          </p>
          <p>
        ...
        <h1 className="containerH1">APPROACH & SOLUTION</h1>
        <ul>
          <li>
            <strong>Data Transparency</strong>: OP Medicine utilises a
            distributed computer network platform that enables databases to
            store time-stamped transaction records and documents.
          </li>
          <li>
